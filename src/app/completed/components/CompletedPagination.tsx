        ...
        <div className="flex flex-wrap w-full items-center justify-center md:justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
                ...
                <Input
                    ...
                    onBlur={() => {
                        if (!page) setPage('1');
                        router.push(`/completed?page=${page ? page : '1'}${originalLanguageQuery}`, { scroll: false });
                        window.scrollTo(0, 0);
                    }}
                />
            </div>
                    ...
                    <PaginationContent>
                        ...
                        <PaginationItem>
                            <PaginationLink
                                ...
                                href={currentPage === 1 ? undefined : `/completed?page=1${originalLanguageQuery}`}
                        ...
                        <PaginationItem>
                            <PaginationLink
                                className="aria-disabled:pointer-events-none aria-disabled:opacity-50 border"
                                href={currentPage === 1 ? undefined : `/completed?page=${currentPage - 1}${originalLanguageQuery}`}
                        ...
                        <PaginationItem>
                            <PaginationLink
                                className="aria-disabled:pointer-events-none aria-disabled:opacity-50 border"
                                href={currentPage === totalPages ? undefined : `/completed?page=${currentPage + 1}${originalLanguageQuery}`}
                        ...
                        <PaginationItem>
                            <PaginationLink
                                className="aria-disabled:pointer-events-none aria-disabled:opacity-50 border"
                                href={currentPage === totalPages ? undefined : `/completed?page=${totalPages}${originalLanguageQuery}`}
