...
import { showSuccessfullyLoadedAllImagesToast } from '@/app/lib/mangadexToasts';
import ChapterImageProxy from '@/app/manga/[id]/chapter/[chapterId]/components/ChapterImageProxy';
...
export default function ChapterImagesContainerAndCounter({ title, currentChapter, baseUrl, hash, images }: ChapterImagesContainerAndCounterProps) {
    ...
    }, [numberOfImagesLoaded, images.length]);
